...
const BlogCommentsCard = class {
    ...
    render() {
        return (h("div", { class: "card" }, h("div", { class: "card__author" }, h("p", { class: "author" }, this.author)), h("div", { class: "card__content" }, h("h3", { class: "content" }, this.content))));
    }
};
BlogCommentsCard.style = blogCommentsCardCss;

export { BlogCommentsCard as blog_comments_card };
