...
const BlogSocialIcons = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "col-md-4 col-sm-6 col-xs-12" }, index.h("ul", { class: "social-icons" }, index.h("li", null, index.h("a", { class: "facebook", href: "#" }, index.h("i", { class: "fa fa-facebook" }, "F"))), index.h("li", null, index.h("a", { class: "twitter", href: "#" }, index.h("i", { class: "fa fa-twitter" }, "T"))), index.h("li", null, index.h("a", { class: "dribbble", href: "#" }, index.h("i", { class: "fa fa-dribbble" }, "D"))), index.h("li", null, index.h("a", { class: "linkedin", href: "#" }, index.h("i", { class: "fa fa-linkedin" }, "L")))))));
    }
};
BlogSocialIcons.style = blogSocialIconsCss;

exports.blog_social_icons = BlogSocialIcons;
